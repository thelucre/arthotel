...
/***/ function(module, exports, __webpack_require__) {
	...
	App = new Vue({
	  ...
	  components: {
	    ...
	    marquee: __webpack_require__(11),
	    kickstarter: __webpack_require__(13),
	    about: __webpack_require__(15),
	    submissions: __webpack_require__(17),
	    artists: __webpack_require__(19),
...
/***/ function(module, exports) {
	...
	module.exports = "<div id='menu' v-bind:class='classes'>\n  <p>menu</p>\n  <div class='close' v-on:click='toggle'>x</div>\n  <template v-if='routes'>\n    <li v-for='(path, link) in routes'>\n      <a v-link='path' v-on:click='close'>{{ link.label }}</a>\n    </li>\n  </template>\n</div>";
